...
- Atlas grid: 3 columns desktop, 2 at ≤800px, 1 at ≤540px, with a 16px gap.
...
- **`provenanceAuthor` / `provenanceRecomputed`**: the provenance signal, visible on cards and in the
  detail view.
