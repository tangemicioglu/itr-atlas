...
inputs:
  ...
  - symbol: "rate"
    value: "4.4"
    unit: "char/min"
    sourceNote: "Back-derived from the reported 0.38 bits/s Wolpaw ITR at N=72, 92% accuracy (≈5.28 bits/selection → ~4.4 selections/min); P300 spellers are slow because each selection needs many flash repetitions averaged."
  - symbol: "P"
    value: "0.92"
  ...
  - symbol: "ITR_reported"
    value: "23"
    unit: "bits/s"
    sourceNote: "Authors' mean Wolpaw bit rate for the checkerboard paradigm (up from 0.32 bits/s for row/column). Counts log2(N) per selection."
actionSpace:
  kind: fixed-set
  size: 72
  ...
  - id: comm
    ...
    steps:
      ...
      - title: "Information transfer rate"
        math: "4.0 char/min × 1.0 bit/char ÷ 60 s/min = 0.067 bits/s"
  - id: reported
